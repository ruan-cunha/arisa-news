const newsData = [
    {
        ...
        body: "ARISA has officially confirmed a successful joint operation involving operative from The Paramount and The Vanguards. The mission, classified until this morning, involved the stabilization of a rogue geo-political event. Operatives 'Downdraft' and 'Kinesis' were instrumental in evacuating civilians and providing tactical mobility in a hostile environment."
    },
    {
    ...
    },
    {
        ...
        body: "The Vanguards initiative has been publicly commended for its rapid and effective response to a mag-lev transport malfunction on the west coast. Operatives 'Flashpoint' and 'Chisel' successfully halted the runaway vehicle, preventing a major catastrophe. The incident underscores the value and effectiveness of the youth initiative under extreme pressure."
    }
];
